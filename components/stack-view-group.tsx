...
export function StackViewGroup(props: StackViewGroupProps) {
   ...
   return (
      <div
         ...
         ref={ref}
         draggable="false"
         class={["stack-view-group", rest.class]}
      >
...
export function StackView(props: StackViewProps) {
   ...
   return (
      <div
         ...
         class={["stack-view-group-view", rest.class]}
      >
         {If(contentLoaded, content)}
         {If(canSwipe, () => (
            <div
               class="stack-view-group-view-pull-handle"
...
function getStackGroupElement(element: HTMLElement | null): HTMLElement | null {
   ...
   if (!stack || !stack.classList.contains("stack-view-group")) {
      return null;
   }
   return stack;
}
