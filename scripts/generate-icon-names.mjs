...
const iconsDir = path.resolve('components/icons');
// Change output file extension to .tsx
const outputFile = path.resolve('components/icon-name.tsx');
...
`;
    ...
    console.log(`Successfully generated ${outputFile} with ${iconNames.length} icon names and components.`);
